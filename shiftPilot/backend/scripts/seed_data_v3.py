...
def seed_users(db):
    """Seed users: 1 admin, 2 managers, 10 employees."""
    print("Seeding users...")
    ...
    users = [
        ...
        # New employee for Store 1 - weekend/keyholder coverage
        Users(
            id=100013,
            email="employee10@shiftpilot.com",
            firstname="Employee",
            surname="Ten",
            password_hash=get_password_hash("employee123"),
            is_active=True,
        ),
        # New full-time employee for Store 1 - CS and evening keyholder
        Users(
            id=100014,
            email="employee11@shiftpilot.com",
            firstname="Employee",
            surname="Eleven",
            password_hash=get_password_hash("employee123"),
            is_active=True,
...
def seed_user_roles(db):
    ...
    roles = [
        ...
        UserRoles(id=100013, user_id=100013, store_id=100001, role=Role.EMPLOYEE),
        UserRoles(id=100014, user_id=100014, store_id=100001, role=Role.EMPLOYEE),
    ]
...
def seed_employees(db):
    ...
    employees = [
        ...
        # Employee 3 (Store 1) - Keyholder, Part time, only afternoons/evenings
        Employees(
            id=100005,
            user_id=100006,
            store_id=100001,
        ...
        # Employee 10 (Store 1) - Keyholder, weekend specialist, covers Tills + CS
        Employees(
            id=100012,
            user_id=100013,
            store_id=100001,
...
def seed_employee_departments(db):
    ...
    links = [
        ...
        # Employee 10 (Store 1) - Tills primary, can do CS (weekend specialist)
        EmployeeDepartments(employee_id=100012, department_id=100001, is_primary=True),
        EmployeeDepartments(employee_id=100012, department_id=100004, is_primary=False),
        # Employee 11 (Store 1) - CS primary, can do Tills (full-time evening keyholder)
        EmployeeDepartments(employee_id=100013, department_id=100004, is_primary=True),
        EmployeeDepartments(employee_id=100013, department_id=100001, is_primary=False),
    ]
...
def seed_availability_rules(db):
    ...
    rules = [
        ...
        AvailabilityRules(id=100025, employee_id=100004, day_of_week=3, start_time_local=time(6, 0), end_time_local=time(14, 0), rule_type=AvailabilityRuleType.AVAILABLE, priority=1, active=True),
        AvailabilityRules(id=100026, employee_id=100004, day_of_week=4, start_time_local=time(6, 0), end_time_local=time(14, 0), rule_type=AvailabilityRuleType.AVAILABLE, priority=1, active=True),
        AvailabilityRules(id=100027, employee_id=100004, day_of_week=5, start_time_local=time(6, 0), end_time_local=time(14, 0), rule_type=AvailabilityRuleType.AVAILABLE, priority=1, active=True),
        AvailabilityRules(id=100028, employee_id=100004, day_of_week=6, start_time_local=time(6, 0), end_time_local=time(14, 0), rule_type=AvailabilityRuleType.AVAILABLE, priority=1, active=True),
        
        # Employee 3 - Part time keyholder, afternoons/evenings for closing coverage
        ...
        AvailabilityRules(id=100023, employee_id=100005, day_of_week=1, start_time_local=time(14, 0), end_time_local=time(22, 0), rule_type=AvailabilityRuleType.AVAILABLE, priority=1, active=True),
        AvailabilityRules(id=100024, employee_id=100005, day_of_week=3, start_time_local=time(14, 0), end_time_local=time(22, 0), rule_type=AvailabilityRuleType.AVAILABLE, priority=1, active=True),
        ...
        # Employee 10 (Store 1) - Available Thu-Sun, keyholder for late week/weekend coverage
        AvailabilityRules(id=100019, employee_id=100012, day_of_week=3, start_time_local=time(6, 0), end_time_local=time(22, 0), rule_type=AvailabilityRuleType.AVAILABLE, priority=1, active=True),
        AvailabilityRules(id=100020, employee_id=100012, day_of_week=4, start_time_local=time(6, 0), end_time_local=time(22, 0), rule_type=AvailabilityRuleType.AVAILABLE, priority=1, active=True),
...
def main():
    ...
    try:
        ...
        print("            (employee 2-11 follow same pattern)")
        print("="*50 + "\n")
